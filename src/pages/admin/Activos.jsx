...
>
  <div className="bg-white p-6 rounded-lg">
    ...
    <form onSubmit={handleCambioEstado}>
      <div className="mb-6">
        <label htmlFor="estadoNuevo" className="block text-sm font-medium text-emi_azul mb-2">
          Nuevo Estado
        </label>
        <select
          id="estadoNuevo"
      ...
      <div className="mb-6">
        <label htmlFor="motivoCambio" className="block text-sm font-medium text-emi_azul mb-2">
          Motivo del Cambio
        </label>
        <textarea
          id="motivoCambio"
          name="motivoCambio"
          rows="3"
          className="block w-full border-gray-300  text-black rounded-md shadow-sm py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
