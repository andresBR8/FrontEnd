      ...
      <Image style={styles.logo} src={base64Logo} />
        ...
        <View style={styles.table}>
          <View style={styles.tableRow}>
            <View style={{...styles.tableColHeader, width: '5%'}}><Text style={styles.tableCell}>Nº Item</Text></View>
            <View style={{...styles.tableColHeader, width: '20%'}}><Text style={styles.tableCell}>Código Activo</Text></View>
            <View style={{...styles.tableColHeader, width: '50%'}}><Text style={styles.tableCell}>Descripción</Text></View>
            <View style={{...styles.tableColHeader, width: '10%'}}><Text style={styles.tableCell}>Estado</Text></View>
            <View style={{...styles.tableColHeader, width: '20%'}}><Text style={styles.tableCell}>Fecha Compra</Text></View>
          </View>
