...
export default function AssetManagement() {
  ...
  const handleUnitChange = (value) => {
    ...
    applyFilters(searchTerm, dateRange, value, selectedRole);
  };

  const handleRoleChange = (value) => {
    setSelectedRole(value);
    applyFilters(searchTerm, dateRange, selectedUnit, value);
  };
  ...
  const renderSkeletonRow = () => (
    <tr className="bg-white border-b">
      ...
      <td className="py-4 px-6"><Skeleton.Input active size="small" /></td>
      <td className="py-4 px-6"><Skeleton.Input active size="small" /></td>
      <td className="py-4 px-6"><Skeleton.Input active size="small" /></td>
      <td className="py-4 px-6"><Skeleton.Input active size="small" /></td>
      <td className="py-4 px-6"><Skeleton.Input active size="small" /></td>
    ...
    <div className="p-4 bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          <h2 className="text-xl font-semibold text-emi_azul mb-4">Filtros</h2>
